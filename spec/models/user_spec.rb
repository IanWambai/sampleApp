...
describe User do
	...
	it "should accept valid email addresses" do
		addresses = %w[user.foo.com USER@foo.bar.org user.foo@bar.jp]
		addresses.each do |address|
			valid_email_user = User.new(@attt.merge(:email => address))
	...
	it "should reject invalid addresses" do
		...
		addresses.each do |address|
			invalid_email_user = User.new(@attt.merge(:email => address))
	...
	describe "password validations" do
		...
		it "should reject short passswords" do
			short = "a"*5
			hash = @attr.merge(:password => short, :password_confirmation => short)
			User.new(hash).should_not be_valid
		end

		it "should reject long passswords" do
			long = "a"*41
